...
export const StructuredFeedbackSchema = z
    ...
    .refine((feedback) => feedback.value !== undefined ||
    feedback.difficulty !== undefined ||
    feedback.length !== undefined ||
    (feedback.flags !== undefined && feedback.flags.length > 0) ||
    (feedback.tags !== undefined && feedback.tags.length > 0), { message: "StructuredFeedback requires at least one populated field" });
/**
