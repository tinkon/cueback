...
import { ConsumptionSummarySchema } from "./receipt.js";
 ...
 */
export const StandingFeedbackNoteSchema = z.object({
    /**
...
export const StandingFeedbackSchema = z.object({
    ...
    notes: z.array(StandingFeedbackNoteSchema).max(40),
    /** This user has written more than the block carries. Omitted when false. */
    more_on_file: z.literal(true).optional(),
});
